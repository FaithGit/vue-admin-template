...
export function findWarTypeNum(data) { // 查找一张图异常类型数据数量
  return request({
    url: 'http://47.96.147.99:8081/hbjk/findWarTypeNum',
    method: 'POST',
    data
  })
}
export function findLoginLog(data) { // 查找登录日志数据
  return request({
    url: 'http://47.96.147.99:8081/hbjk/findLoginLog',
    method: 'POST',
    data
  })
}
